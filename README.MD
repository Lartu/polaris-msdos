...
- If you are on a **MS-DOS** system, get [Turbo C](https://edn.embarcadero.com/article/20841). Then from Turbo C open `polaris.c` and then go to Compile 🡒 Make EXE file.
